...
namespace UniversityTimetable.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        //public ManageController(IUserService userManager, IAuthenticationManager signInManager)
        //{
        ...
        //    var result = await IUserService.RemoveLoginAsync(User.Identity.GetUserId(), new UserLoginInfo(loginProvider, providerKey));
        //    if (result.Succeeded)
        //    {
        //        var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
        //        if (user != null)
